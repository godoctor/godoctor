...
<div id="install-godoctor" class="showable">
  <ol class="enum">
    <li><tt>go get github.com/godoctor/godoctor.git</tt><br/>
    ...
    directory on your MANPATH.  For example:<br/><br/>
      &nbsp;&nbsp;&nbsp;&nbsp;
      <tt>sudo godoctor -doc man &gt;/usr/local/share/man/man1/godoctor.1</tt><br/></li>
  </ol>
</div>
...
<div id="install-vim" class="showable">
  ...
  <ol class="enum">
    ...
    <li>Continue with <a href="#step2">Step 2</a> below.</li>
  </ol>
  ...
  <h3>Steps Common to Both Options</h3>
  <a name="step2"></a>
  <ol class="enum" start="2">
    ...
    plug-in's <i>doc</i> directory.  For example:<br/><br/>
      &nbsp;&nbsp;&nbsp;&nbsp;
      <tt>godoctor -doc vim &gt;$GOPATH/src/github.com/godoctor/godoctor/cmd/godoctor/vim/doc/godoctor-vim.txt</tt></li>
